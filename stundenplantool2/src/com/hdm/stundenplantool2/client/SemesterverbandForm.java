...
public class SemesterverbandForm extends VerticalPanel {
	...
	public void fillForm() {
		...
		this.anzahlStudentenTextBox.setText(new Integer(shownSemesterverband
				.getAnzahlStudenten()).toString());

		for (int i = 0; i < studiengangVector.size(); i++) {
			if (shownSemesterverband.getStudiengang().getId() == studiengangVector
					.elementAt(i).getId()) {
	...
	public void aendernMaske() {
		...
		speichernAnlegenButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				try {
					shownSemesterverband.setAnzahlStudenten(Integer
							.parseInt(anzahlStudentenTextBox.getText()));
										...
										.auslesenSemesterverband(
												...
												new AsyncCallback<Vector<Semesterverband>>() {
													...
													public void onSuccess(
														...
														dtvm.setSelectedSemesterverband(result
																.elementAt(0));
														speichernAnlegenButton
																.setEnabled(true);
														loeschenButton
	...
	public void anlegenMaske() {
		...
		speichernAnlegenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				verwaltung.anlegenSemesterverband(anzahlStudentenTextBox
						.getText(), jahrgangTextBox.getText(),
